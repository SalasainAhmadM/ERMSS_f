...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2024 at 02:49 PM
...
(340, 'Sabaody123ffff', 'adasdasdasd', 'Training Sessions', 'Face-to-Face', '', 'grandlinedsadas', '2024-11-05', '2024-11-07', '08:00:00', '17:00:00', '2024-11-03 11:23:36', '', '', '', 10, ''),
...
--
ALTER TABLE `attendance`
  MODIFY `attendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=249;
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `MarkAbsent` ON SCHEDULE EVERY 1 MINUTE STARTS '2024-11-04 00:02:27' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
    -- Insert an "absent" record for participants in ongoing events who haven't checked in today
    INSERT INTO attendance (participant_id, event_id, attendance_date, status, created_at, day)
    SELECT 
        ep.participant_id,
        ep.event_id,
