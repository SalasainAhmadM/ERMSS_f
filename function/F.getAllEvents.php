<?php
    ...
    // Fetch events from the database based on the current date and time, excluding events with non-empty event_cancel
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // Display all event statuses (upcoming, ongoing, and ended)
