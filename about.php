        ...
        <main class="main">
                        ...
                        <div class="about__data grid">
                            <div class="about__info grid">
                                ...
                                <p class="about__description">
                                    description of the company here bla <b>yes</b> bla chu <b>okay</b> chu
                                </p>
                            </div>
            ...
            <div class="goals__container contaienr grid">
                <article class="goals__card">
                    <!--remixicon--><i class="ri-code-s-slash-line goals__icon"></i>
                        ...
                        <div class="swiper-wrapper">
                            <article class="team__card swiper-slide">
                                <div class="team__border">
                                    <img src="assets/img/innovixLogo-removebg-preview.png" alt="" class="team__img">
                                </div>
                            ...
                            <article class="team__card swiper-slide">
                                <div class="team__border">
                                    <img src="assets/img/innovixLogo.png" alt="" class="team__img">
                                </div>
                            ...
                            <article class="team__card swiper-slide">
                                <div class="team__border">
                                    <img src="assets/img/wesmaarrdec.jpg" alt="" class="team__img">
                                </div>
